                                ...
                                <div>
                                    ...
                                    <div class=" form-group col-sm-10">
                                        <input name="buying_unit_price" class="form-control example-date-input"
                                            type="text" id="buying_unit_price" readonly style="background-color: #ddd">
                                    </div>
                                </div>
                            </div>
...
<script type="text/x-handlebars-template" id="document-template">
    <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <!--
            <td>
                <input type="number" class="text-right form-control buying_unit_price" name="buying_unit_price" id="buying_unit_price" value="@{{buying_unit_price}}" readonly>
            </td>
            -->
            ...
            <!--
             <td>
                <input type="number" class="text-right form-control selling_price" name="profit_loss" id="profit_loss" value="0" readonly>
            </td>
            -->
