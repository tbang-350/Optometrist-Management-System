                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('prescription.store') }}" id="myForm"
                                    ...
                                    <div class="row new_customer">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control"
                                                ...
                                                value="{{ $consultation->customer->name ?? '' }}" readonly>
                                            <br>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="age" name="age" id="age" class="form-control"
                                                ...
                                                value="{{ $consultation->customer->age ?? '' }}" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="address" name="address" id="address" class="form-control"
                                                ...
                                                value="{{ $consultation->customer->address ?? '' }}" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="sex" id="sex" class="form-select"
                                                ...
                                                <option value="male" @if ($consultation->customer->sex == 'male') selected @endif>
                                                    Male</option>
                                                <option value="female" @if ($consultation->customer->sex == 'female') selected @endif>
                                                    Female</option>
                                            </select>
                                        </div>
                                ...
                                @else
                                    <p>No consultation data found for this ID.</p>
                                @endif
